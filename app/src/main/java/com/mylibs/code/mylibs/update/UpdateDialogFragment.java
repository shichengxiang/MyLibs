...
//                });
    ...
    private void setDialogTheme(int color, int topResId) {
        ...
        mUpdateOkButton.setBackgroundDrawable(com.mylibs.code.mylibs.update.DrawableUtil.getDrawable(AppUpdateUtils.dip2px(4, getActivity()), color));
        mNumberProgressBar.setProgressTextColor(color);
        mNumberProgressBar.setReachedBarColor(color);
        //随背景颜色变化
        mUpdateOkButton.setTextColor(com.mylibs.code.mylibs.update.ColorUtil.isTextColorDark(color) ? Color.BLACK : Color.WHITE);
    }
